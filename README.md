...
<div class="face-one-intro">
    <div class="face-one-intro-title">tabs.react</div>
    <h2 class="face-one-intro-desc">
        多种风格 Tabs
    </h2>
    <div class="face-one-intro-tool">
        <a href="https://onface.github.io/tabs.react" class="face-one-intro-btn face-one-intro-btn--primary mr-online-hide" >在线文档</a>
        <!-- MARKRUN-HTML
            <a href="./doc/intro.md" class="face-one-intro-btn face-one-intro-btn--primary">指引</a>
            <a href="http://github.com/onface/tabs.react" class="face-one-intro-btn">GITHUB</a>
        -->
    </div>
</div>
        ...
        <tr>
            <td align="center" >
                <div class="face-one-feature-item">
                    ...
                    <div class="face-one-feature-item-desc">可完全自定义样式</div>
                </div>
            </td>
            <td align="center" >
                <div class="face-one-feature-item">
            ...
            <td align="center" >
                <div class="face-one-feature-item">
                    ...
                    <br />
                    <div class="face-one-feature-item-label">主题丰富</div>
                    <div class="face-one-feature-item-desc">大量预设主题，减少开发成本</div>
                </div>
            </td>
        </tr>
    </table>
